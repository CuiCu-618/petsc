...
//        Fm[0] = (3*E*PetscExpReal(x+2*y+3*z))/(4*nu*nu + 2*nu - 2);
//        Fm[1] = (3*E*exp(x+2*y+3*z))/(2*nu*nu + nu - 1);
//        Fm[2] = -(E*exp(x + 2*y + 3*z)*(28*nu - 23))/(4*nu*nu + 2*nu - 2);
    }
    if (Gm) {
...
//        Gm[2][0] = PetscExpReal(x+2*y+3*z);
//        Gm[2][1] = 2.0*PetscExpReal(x+2*y+3*z);
//        Gm[2][2] = 3.0*PetscExpReal(x+2*y+3*z);
